                    ...
                    if (!window.externalProviderLogin) {
                        window.externalProviderLogin = function (auth) {
                            _this.zone.run(function () {
                                _this.externalProviderLogin(auth);
                            });
                        };
                    }
                }
