System.register(["@angular/core", "@angular/platform-browser", "@angular/http", "@angular/forms", "@angular/router", "rxjs/Rx", "./app.component", "./item-list.component", "./item-detail-edit.component", "./item-detail-view.component", "./about.component", "./home.component", "./login.component", "./user-edit-component", "./page-not-found.component", "./app.routing", "./item.service", "./auth.service", "./auth.http"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, http_1, forms_1, router_1, app_component_1, item_list_component_1, item_detail_edit_component_1, item_detail_view_component_1, about_component_1, home_component_1, login_component_1, user_edit_component_1, page_not_found_component_1, app_routing_1, item_service_1, auth_service_1, auth_http_1, AppModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
