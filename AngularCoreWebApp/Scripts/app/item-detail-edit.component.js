    ...
    return {
        ...
        execute: function () {
            ItemDetailEditComponent = (function () {
                function ItemDetailEditComponent(itemService, activatedRoute, router, authService) {
                ...
                ItemDetailEditComponent.prototype.onInsert = function (item) {
                    ...
                    this.itemService.add(item)
                        ...
                        _this.item = data;
                        console.log("item " + _this.item.Id + " added");
                ...
                ItemDetailEditComponent.prototype.onUpdate = function (item) {
                    ...
                    this.itemService.update(item)
                        .subscribe(function (data) {
                        _this.item = data;
                        console.log("item " + _this.item.Id + " updated");
                        _this.router.navigate(["item/view", _this.item.Id]);
                    }, function (error) { return console.log(error); });
                };
