...
namespace AngularCoreWebApp.Data
{
    public class DbSeeder
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!DbContext.OpenIddictApplications.Any()) CreateApplication();
        ...
        {
            DbContext.OpenIddictApplications.Add(new OpenIddictApplication
            {
        ...
        private void CreateItems()
        {
            ...
            EntityEntry<Item> e1 = DbContext.Items.Add(new Item()
            {
                ...
                Text =
                    @"Loosely based on Magic: The Gathering, the game lets you play against a computer opponent or another human being. 
            ...
            EntityEntry<Item> e2 = DbContext.Items.Add(new Item()
            {
                ...
                Text =
                    @"The Minetest gameplay is very similar to Minecraft's: you are playing in a 3D open world, where you can create and/or remove various types of blocks. 
            ...
            EntityEntry<Item> e4 = DbContext.Items.Add(new Item()
            {
                ...
                Text =
                    @"The game is currently under Milestone 3. The Milestone 2, which is currently out, features the following:
            ...
            EntityEntry<Item> e5 = DbContext.Items.Add(new Item()
            {
                ...
                Text =
                    @"Scrabble3D extends the gameplay of the classic game Scrabble by adding a new whole third dimension. 
        ...
        private Item GetSampleItem(int id, string authorId, int viewCount, DateTime createdDate)
        {
            return new Item()
            {
                ...
                Description = String.Format("This is a sample description for item {0}: Lorem ipsum dolor sit amet.",
                    id),
                Notes = "This is a sample record created by the Code-First Configuration class",
                ViewCount = viewCount,
                CreatedDate = createdDate,
